...
MODEL                = PV_Battery_Grid2021a
MODULES              = PV_Battery_Grid2021a_acc.c PV_Battery_Grid2021a_acc_data.c rtGetInf.c rtGetNaN.c rt_look.c rt_look1d.c rt_nonfinite.c c_mexapi_version.c lccstub.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/PV_Battery_Grid2021a_acc.mexw64
MAKEFILE             = PV_Battery_Grid2021a.mk
MATLAB_ROOT          = C:/Program Files/MATLAB/R2022b
ALT_MATLAB_ROOT      = C:/PROGRA~1/MATLAB/R2022b
START_DIR            = D:/Risen光储充/BF79光储微电网离并网MATLAB模型
S_FUNCTIONS_LIB      = 
NUMST                = 9
NCSTATES             = 38
...
MODELLIB                  = PV_Battery_Grid2021a_acc.mexw64
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = PV_Battery_Grid2021a_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/accel/PV_Battery_Grid2021a \
...
PV_Battery_Grid2021a_acc.obj : $(START_DIR)/slprj/accel/PV_Battery_Grid2021a/PV_Battery_Grid2021a_acc.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/PV_Battery_Grid2021a/PV_Battery_Grid2021a_acc.c

PV_Battery_Grid2021a_acc_data.obj : $(START_DIR)/slprj/accel/PV_Battery_Grid2021a/PV_Battery_Grid2021a_acc_data.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/PV_Battery_Grid2021a/PV_Battery_Grid2021a_acc_data.c

rtGetInf.obj : $(START_DIR)/slprj/accel/PV_Battery_Grid2021a/rtGetInf.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/PV_Battery_Grid2021a/rtGetInf.c

rtGetNaN.obj : $(START_DIR)/slprj/accel/PV_Battery_Grid2021a/rtGetNaN.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/PV_Battery_Grid2021a/rtGetNaN.c

rt_look.obj : $(START_DIR)/slprj/accel/PV_Battery_Grid2021a/rt_look.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/PV_Battery_Grid2021a/rt_look.c

rt_look1d.obj : $(START_DIR)/slprj/accel/PV_Battery_Grid2021a/rt_look1d.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/PV_Battery_Grid2021a/rt_look1d.c

rt_nonfinite.obj : $(START_DIR)/slprj/accel/PV_Battery_Grid2021a/rt_nonfinite.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/PV_Battery_Grid2021a/rt_nonfinite.c
